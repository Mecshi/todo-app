...
export const NavBar = ({ navBar, setNavBar }) => {
  return (
    <header className='flex justify-center'>
      <nav className='flex justify-between items-center  bg-tahiti-600 h-20 px-4 w-full
...

          {
            menuNav.map(({ link, path }) => {
              return (
                ...
                >
                  <li
                    className='cursor-pointer text-tahiti-100 text-2xl font-medium hover:text-tahiti-200 hover:duration-200 hover:line-through'
                    key={link}
